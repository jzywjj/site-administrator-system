...
public class LftUtils {
	...
	public static String generateVerificationCode() {
        ...
        for(int i = 0; i < 2; ++i) {
            ...
            sb.append(String.format("%02d", ends));
        }
		return sb.toString();
	}
	 ...
	 * @throws IOException
	 */
	public static void sendSms(String phoneNum,String verificationCode) throws Exception {

        //必填,请参考"开发准备"获取如下数据,替换为实际值 https://rtcsms.cn-north-1.myhuaweicloud.com:10743
        String url = "https://rtcsms.cn-north-1.myhuaweicloud.com:10743/sms/batchSendSms/v1"; //APP接入地址+接口访问URI
        String appKey = "105J4mtiq5yP0Uz288g7A0A73TY9"; //APP_Key
        String appSecret = "uW52Bm9xz5Y18G329JSu8zlmttg0"; //APP_Secret
        String sender = "882003128776"; //国内短信签名通道号或国际/港澳台短信通道号
        String templateId = "8acb38d1f6434fcea12646f809e11c0d"; //模板ID

        //条件必填,国内短信关注,当templateId指定的模板类型为通用模板时生效且必填,必须是已审核通过的,与模板类型一致的签名名称
        //国际/港澳台短信不用关注该参数
        String signature = "亮风台数据中心"; //签名名称
         ...
         */
        String templateParas = "[\""+verificationCode+"\"]"; //模板变量
